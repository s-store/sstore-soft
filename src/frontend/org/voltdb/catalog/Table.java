...
public class Table extends CatalogType {
    ...
    void setBaseValues(Catalog catalog, CatalogType parent, String path, String name) {
        ...
        m_fields.put("groupByIndex", m_groupByIndex);
    }
    ...
    public void update() {
        ...
        m_groupByIndex = (Integer) m_fields.get("groupByIndex");
    }
    ...
    /**
     * GETTER: A rough estimate of the number of tuples in the table; used for
     * planning
     */
    ...
    /**
     * GETTER: Information about materialized views based on this table's
     * content
     */
    ...
    /**
     * GETTER: If this is a materialized view, this field stores the source
     * table
     */
    ...
    /**
     * GETTER: The window column index to group on before windowing for row
     * based window only. Negative index value indicates no group.
     */
    ...
    public void setIsreplicated(boolean value) {
        ...
        m_fields.put("isreplicated", value);
    }
    ...
    /**
     * SETTER: A rough estimate of the number of tuples in the table; used for
     * planning
     */
    public void setEstimatedtuplecount(int value) {
        m_estimatedtuplecount = value;
        m_fields.put("estimatedtuplecount", value);
    }

    /**
     * SETTER: If this is a materialized view, this field stores the source
     * table
     */

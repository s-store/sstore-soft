...
//            long undoQuantumToken) throws EEException;
    ...
    */
    ...
    public abstract long extractTable(Table extractTable, String destinationShim, String destinationFile, boolean caching);
    
    protected native long nativeExtractTable(long pointer, int tableId, String destinationShim, String destinationFile, boolean caching);
    
    // ----------------------------------------------------------------------------
    // LOADING
    // ----------------------------------------------------------------------------
    
    public abstract long loadTableFromFile(Table loadTable, String destinationShim, String destinationFile);
    
    protected native long nativeLoadTableFromFile(long pointer, int tableId, String destinationShim, String destinationFile);

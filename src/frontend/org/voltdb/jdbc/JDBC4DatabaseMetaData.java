...
/**
 * Implementation to access MetaData of database.
 * Modified for HStore\
 */
public class JDBC4DatabaseMetaData implements DatabaseMetaData
{
    ...
    JDBC4DatabaseMetaData(JDBC4Connection connection) throws SQLException
    {
        ...
        this.sysCatalog = connection.prepareCall("{call @GetSystemInfo(?)}");
    }

    private String buildString = "defaultBuildString";
    private String versionString = "defaultversionstring";
    private String catalogString = "defaultcatalogString";
    ...
    public ResultSet getProcedureColumns(String catalog, String schemaPattern, String procedureNamePattern, String columnNamePattern) throws SQLException
    {
        ...
        while (res.next()) {
        	System.out.println(res.getString("PROCEDURE_NAME"));

...
//    protected AbstractTransaction txnState;  // assigned in call()
    ...
    private boolean sendArgsDownStream = false;
    private String sendArgsDownStreamTblName = "";
    private long[] sendArgsDownStreamExtraArgs;
    private int sendArgsDownStreamDestinationPartition;
...
//        this.txnState = txnState;
    ...
    public VoltTable[] voltExecuteSQL() {
        this.sendArgsDownStream = false;
        return voltExecuteSQL(false, false);
    }

    public VoltTable[] voltExecuteSQLDownStream(String tableName) {
        this.sendArgsDownStream = true;
        this.sendArgsDownStreamTblName = tableName.toUpperCase();
        return voltExecuteSQL(false, false);
    }

    public VoltTable[] voltExecuteSQLDownStream(String tableName, int destinationPartitionId) {
        this.sendArgsDownStream = true;
        this.sendArgsDownStreamTblName = tableName.toUpperCase();
        this.sendArgsDownStreamDestinationPartition = destinationPartitionId;
        return voltExecuteSQL(false, false);
    }

    public VoltTable[] voltExecuteSQLDownStream(String tableName, int destinationPartitionId, long... parameters) {
        this.sendArgsDownStream = true;
        this.sendArgsDownStreamTblName = tableName.toUpperCase();
        this.sendArgsDownStreamExtraArgs = parameters;
        this.sendArgsDownStreamDestinationPartition = destinationPartitionId;
        return voltExecuteSQL(false, false);
    }

    public VoltTable[] voltExecuteSQLDownStream(String tableName, long... parameters) {
        this.sendArgsDownStream = true;
        this.sendArgsDownStreamTblName = tableName.toUpperCase();
        this.sendArgsDownStreamExtraArgs = parameters;
        return voltExecuteSQL(false, false);
    ...
    private VoltTable[] executeQueriesInABatch(final int batchSize,
        ...
        if (this.sendArgsDownStream) {
            VoltTable outTable = CatalogUtil.getVoltTable(this.executor.getCatalogContext().getTableByName(this.sendArgsDownStreamTblName));

            for (int i = 0; i < batchSize; i++) {
                outTable.addRow(params[i].toArray());

            }
            localTxnState.addDownStreamTable(this.sendArgsDownStreamTblName, outTable);
            localTxnState.setDownStreamDestinationPartition(this.sendArgsDownStreamDestinationPartition);
            if (this.sendArgsDownStreamExtraArgs != null) {
                localTxnState.addDownStreamExtraArgs(this.sendArgsDownStreamExtraArgs);
            }
        }

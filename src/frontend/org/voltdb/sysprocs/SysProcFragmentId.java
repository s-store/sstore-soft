...
public class SysProcFragmentId {
    ...
    */
    ...
    // @GetConfiguration
    public static final int PF_getConfiguration = 302;
    
    // @ReconfigurationRemote 
    public static final int PF_extractionRemoteDistribute = 406;
    public static final int PF_extractionRemoteAggregate = 407;

    // @
    public static final int PF_loadingRemoteDistribute = 420;
    public static final int PF_loadingRemoteAggregate = 421;
}
